      ...
      <main>
        <section className="min-h-screen p-10 bg-gray-100">
          <div className="max-w-[68.75rem] mx-auto w-11/12">
            <h1 className="mb-4 text-4xl font-bold">🌟 GetOG 🌟</h1>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mt-10 grid md:grid-cols-[2fr,3fr] gap-8 items-center">
                  <div className="flex flex-col gap-3 md:max-w-sm">
                    ...
                    <Input label="Background Image" id="backgroundImage" placeholder="Image URL" helperText="default: https://lrmn.is-a.dev/images/bg.jpg" />
                    <Input label="Logo" id="logo" placeholder="Logo URL" helperText="default: https://lrmn.is-a.dev/images/lrmn.png" />
